...
classdef HPM_extrap
    ...
    methods
        function obj = HPM_extrap(X1, U1, X0, U0, dt, hyp)
            obj.X1 = X1;
            obj.U1 = U1;
        ...
        function [next_mean, next_var] = extrap_predict(obj, oldx, oldu, oldvars, newx)
            ...
            K11 = k11(newx, newx, hyp_, 0);
            K10 = k10(newx, oldx, hyp_, oldu, dt_, 0);
            K00 = k00(oldx, oldx, hyp_, oldu, oldu, dt_, 0);
            
            % add pointwise noise estimate
            L = jit_chol(K00+diag(abs(oldvars)));
